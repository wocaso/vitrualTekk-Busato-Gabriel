  ...
  return (
    <div id="itemDetailFlex">
      <div id="itemDetailGrid">
        <h1 className="itemTexto" id="itemDetailTittle">
          {item.tittle}
        </h1>
        <img id="itemDetailPicture" src={item.picture} alt="" />
        <h1 className="itemTexto" id="itemDetailDescription">
          {item.description}
        </h1>
        <h1 className="itemTexto" id="itemDetailPrice">
          ${item.price}
        </h1>
        <div id="ItemCountContainer">
          {onAddConfirm === 0 ? (
            ...
            <ButtonLink text="Finalizar Compra" link="/Cart" />
          )}
        </div>
      </div>
    </div>
